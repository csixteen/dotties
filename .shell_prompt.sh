...
function __promptline {
  ...
  local a_bg="${wrap}48;5;123${end_wrap}"
  local a_sep_fg="${wrap}38;5;183${end_wrap}"
  local b_fg="${wrap}38;5;231${end_wrap}"
  local b_bg="${wrap}48;5;21${end_wrap}"
  local b_sep_fg="${wrap}38;5;183${end_wrap}"
  local c_fg="${wrap}38;5;123${end_wrap}"
  local c_bg="${wrap}48;5;18${end_wrap}"
  local c_sep_fg="${wrap}38;5;183${end_wrap}"
  ...
  local y_bg="${wrap}48;5;21${end_wrap}"
  local y_sep_fg="${wrap}38;5;21${end_wrap}"
